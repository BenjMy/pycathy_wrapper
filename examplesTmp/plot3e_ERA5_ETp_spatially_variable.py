...
Majadas_ETa_dataset = rootPathData/'ETa_Majadas_Buffer20k.netcdf'
Majadas_ETp_dataset = rootPathData/'ETp_Majadas_Buffer20k.netcdf'
Majadas_rain_dataset = rootPathData/'RAIN_Majadas_Buffer20k.netcdf'
...
img = ax.imshow(DEM_new,vmin=0,vmax=10)
plt.colorbar(img)
# simu.show_input(prop="dem",vmin=0,vmax=10)

#%%

np.shape(DEM_new)

simu.update_veg_map(np.ones(np.shape(DEM_new)))
