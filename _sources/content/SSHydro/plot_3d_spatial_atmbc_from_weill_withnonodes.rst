...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      ...
      File "/opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/site-packages/pyvista/core/utilities/fileio.py", line 304, in read
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 33.065 seconds)
