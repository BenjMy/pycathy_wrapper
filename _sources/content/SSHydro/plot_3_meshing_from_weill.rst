...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    🔄 Update parm file 
    🛠  Recompile src files [41s]
    🍳 gfortran compilation [47s]
    b''
    👟 Run processor
    b'\n\n IPRT1=3: Program terminating after output of X, Y, Z coordinate values\n'
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    👟 Run preprocessor
    🔄 Update parm file 
    🛠  Recompile src files [66s]
    🍳 gfortran compilation [72s]
    b''
    👟 Run processor
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 25.094 seconds)
