...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    👟 Run preprocessor
    🔄 update parm file 
    🛠  Recompile src files [68s]
    🍳 gfortran compilation [74s]
    b''
    👟 Run processor
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    🔄 update parm file 
    🛠  Recompile src files [81s]
    🍳 gfortran compilation [87s]
    b''
    👟 Run processor
    b'\n\n IPRT1=3: Program terminating after output of X, Y, Z coordinate values\n'
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 27.647 seconds)
