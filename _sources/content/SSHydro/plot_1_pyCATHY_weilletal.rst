...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    🔄 Update parm file 
    🛠  Recompile src files [47s]
    🍳 gfortran compilation [53s]
    b''
    👟 Run processor
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    plot pressure
    <PIL.Image.Image image mode=RGB size=1024x768 at 0x7FD2A10D8CA0>
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 0.987 seconds)
