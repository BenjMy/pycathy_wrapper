...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      ...
      File "/home/runner/work/pycathy_wrapper/pycathy_wrapper/pyCATHY/cathy_tools.py", line 669, in run_processor
        p = subprocess.run(
      File "/opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/subprocess.py", line 503, in run
        with Popen(*popenargs, **kwargs) as process:
      File "/opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/subprocess.py", line 971, in __init__
        self._execute_child(args, executable, preexec_fn, close_fds,
      File "/opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/subprocess.py", line 1863, in _execute_child
