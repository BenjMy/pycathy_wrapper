...
.. "content/SSHydro/plot_pyCATHY_inputs.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_content_SSHydro_plot_pyCATHY_inputs.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_content_SSHydro_plot_pyCATHY_inputs.py:
...
.. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_001.png
   :alt: plot pyCATHY inputs
   :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_001.png
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_002.png
         :alt: plot pyCATHY inputs
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_003.png
         :alt: view from top (before extruding), layer nb4
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_003.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_004.png
         :alt: view from top (before extruding), layer nb1
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_004.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_005.png
         :alt: view from top (before extruding), layer nb2
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_005.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_006.png
   :alt: view from top (before extruding), layer nb10
   :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_006.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_007.png
         :alt: view from top (before extruding), layer nb2
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_007.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_008.png
         :alt: view from top (before extruding), layer nb12
         :srcset: /content/SSHydro/images/sphx_glr_plot_pyCATHY_inputs_008.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_content_SSHydro_plot_pyCATHY_inputs.py:
