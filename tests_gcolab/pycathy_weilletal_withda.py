# -*- coding: utf-8 -*-
"""pyCATHY_weilletal_withDA.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Iq40jjsWKU6JVGtqgLOVLw13yIpaLVT_

🚀 **notebook in progress**

⚠️ 
This notebook is still under construction and has not been tested yet ⚠️
...
The notebook illustrate how to use DA interactively: 
- preprocessing
- processing
- output

You can share it to work collaboratively on it by sharing the link and execute it from another PC without any installation required.
