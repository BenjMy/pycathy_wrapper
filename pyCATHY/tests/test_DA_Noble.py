...
for i, tt in enumerate(data_ass_time_s):
    ...
    dict_obs = simu_test_DA.read_observations(data[colname].iloc[i], 
                                       typ, 
                                       data_err, 
                                       show=False, 
                                       tA=tt,
...
list_pert = perturbate.perturbate(simu_test_DA, 
                                  scenario, 
                                  ensemble_size
                                  )
...
for dp in list_pert:
    ...
    parm_per = DA.perturbate_parm(parm=dp, 
                                        ...
                                        savefig= os.path.join(simu_test_DA.project_name,
                                                              simu_test_DA.project_name + dp['savefig'])
                                        )
