...
CATHY_H_PARAMS = {
    ...
    # SCF-VEG: same as "default", except MAXVEG is raised so multiple
    # vegetation classes -- and therefore multiple per-vegetation-type
    # SCF values -- can actually be represented. Self-contained (like
    # "withIrr" above) rather than relying on merging with "default",
    # since VersionConfigManager's merge behavior with "default" isn't
    # guaranteed here.
    "SCF_variable": {
        "DEMRES": 1,
        "NP2MAX": 1,
